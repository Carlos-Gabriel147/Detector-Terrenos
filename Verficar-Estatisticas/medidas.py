...
def calculo_medias(filename, limit, points):
    ...
    with open("data_asf.txt", "a+") as arq:
...
filename1 = 'Asfalto1.txt'
filename2 = 'Calcamento1.txt'
filename3 = 'Concreto1.txt'
filename4 = 'Terra1.txt'

x_axes, y_axes, z_axes = calculo_medias(filename1, 20, 1000)
